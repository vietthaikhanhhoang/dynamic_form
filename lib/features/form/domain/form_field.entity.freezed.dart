...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,type,label,name,isRequired,nameSaveLabel,nameSaveExtraOption,colSm,colMd,colLg,const DeepCollectionEquality().hash(options),valueIsArray,row,max);

@override
String toString() {
  return 'FormFieldEntity(type: $type, label: $label, name: $name, isRequired: $isRequired, nameSaveLabel: $nameSaveLabel, nameSaveExtraOption: $nameSaveExtraOption, colSm: $colSm, colMd: $colMd, colLg: $colLg, options: $options, valueIsArray: $valueIsArray, row: $row, max: $max)';
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'type')  String? type, @JsonKey(name: 'label')  String? label, @JsonKey(name: 'name')  String? name, @JsonKey(name: 'isRequired')  bool? isRequired, @JsonKey(name: 'nameSaveLabel')  String? nameSaveLabel, @JsonKey(name: 'nameSaveExtraOption')  String? nameSaveExtraOption, @JsonKey(name: 'colSm')  int? colSm, @JsonKey(name: 'colMd')  int? colMd, @JsonKey(name: 'colLg')  int? colLg, @JsonKey(name: 'options')  List<FormFieldOption>? options, @JsonKey(name: 'valueIsArray')  bool? valueIsArray, @JsonKey(name: 'row')  int? row, @JsonKey(name: 'max')  int? max)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FormFieldEntity() when $default != null:
return $default(_that.type,_that.label,_that.name,_that.isRequired,_that.nameSaveLabel,_that.nameSaveExtraOption,_that.colSm,_that.colMd,_that.colLg,_that.options,_that.valueIsArray,_that.row,_that.max);case _:
  return orElse();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,type,label,name,isRequired,nameSaveLabel,nameSaveExtraOption,colSm,colMd,colLg,const DeepCollectionEquality().hash(_options),valueIsArray,row,max);
